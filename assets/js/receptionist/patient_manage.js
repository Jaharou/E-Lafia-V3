...
var PatientManage = (function ($) {
    ...
    function initDataTable(selector) {
        ...
        _table = $table.DataTable({
            ...
            // Pas de tri initial forcé ici : on laisse Patient_model appliquer
            // son tri par défaut (patient_id DESC), pour que les patients
            // nouvellement ajoutés apparaissent en page 1 sans recherche.
            order: [],
            pageLength: 25,
    ...
    function reloadDataTable() {
        if (_table) {
            // "true" ramène à la page 1 : combiné au tri par défaut
            // (patient_id DESC), ça garantit qu'un patient qui vient d'être
            // ajouté est visible immédiatement, sans recherche manuelle.
