...
class InvoiceComptable extends CI_Controller {
    ...
    public function invoice_print($param1 = ''){ 
        if ( $this->session->userdata('accountant_login') == 1 || $this->session->userdata('admin_login') == 1 ):
            ...
            //$reste_payer = $this->db->get_where('invoice', array('invoice_id' => $param1))->row()->reste_payer; 
            ...
            $this->header_value('', $system_name, 'logo', $contact, $address, utf8_decode('Reçu de paiement N°'). $invoice_number, $system_nif);
    ...
    /*public function invoice_note($note = '') {
     ...
     public function invioce_footer($gtotal = '', $currency = '', $remise_amount ='', $prise_charge = '') {
       ...
       $this->fpdf->Cell(35, 9, $gtotal . "", 1, 0, 'C', true);
        ...
        /*$this->fpdf->SetFont('times', 'B', 13);
        $this->fpdf->Cell(100, 9, ("Avance"), 1, 0, 'L', true);
       $this->fpdf->Cell(35, 9, $avance . "", 1, 0, 'C', true);
       $this->fpdf->Ln(12);

        $this->fpdf->SetFont('times', 'B', 13);
        $this->fpdf->Cell(100, 9, utf8_decode("Reste à payer"), 1, 0, 'L', true);
       $this->fpdf->Cell(35, 9, $reste_payer . "", 1, 0, 'C', true);*/
       //$this->fpdf->Ln(12);
    }
    ...
    $this->fpdf->Cell(0, 6, utf8_decode("Le comptable: ") . utf8_decode($atho), 0, 0, 'R');
    $this->fpdf->Ln(5);
    }
