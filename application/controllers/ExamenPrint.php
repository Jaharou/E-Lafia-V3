...
class ExamenPrint extends CI_Controller {
    ...
    public function dhorla_fpdf($param1 = '') {
		...
		$examen_info = $this->crud_model->select_examen_info_by_id($param1);
		foreach ( $examen_info as $val ):		
			...
			$address = $this->db->get_where( 'settings', array( 'type' => 'address' ))->row()->description;
                ...
                //$this->header_design( 'Dernier examen', ': ' .date('d/m/Y', $val['last_date_examen_timestamp']);
                $this->fpdf->Ln(5);
				
                $this->body_design( "Patient", $val['name'] );
                $this->body_design( "Test_examen", $val['libelle_examen'] );
    ...
    public function header_info($barcode_text = '', $title_tab = '', $logo = '', $contact = '', $address = '') {
        ...
        $this->fpdf->Image('uploads/' . $logo . '.jpg', 25, 10, 20, 16);
