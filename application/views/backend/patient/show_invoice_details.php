...
?>
    <div id="invoice_print">
        <header>
            <img class="pull-right" style="height: 100px; width: 200px; padding: -50px;" src="<?php echo base_url(); ?>assets/images/logo.jpeg" alt="logo" class="logo">
        ...
        <table width="80%" border="1">
            <tr>
                <td align="left">
                    ...
                    <span><?php echo get_phrase("date-d'émission"); ?> :<?php echo $row['creation_datetime'];?></span><br>
        ...
        <table width="100%" border="1">    
            ...
            <tr>
                <td align="left" valign="top">
                    ...
                    <?php echo $this->db->get_where('patient', array('patient_id' => $row['patient_id']))->row()->address_patient; ?><br>
        ...
        <table class="table table-bordered" width="100%" border="1" style="border-collapse:collapse;">
            <thead>
                <tr>
                    ...
                    <th width="60%"><?php echo get_phrase('prestation'); ?></th>
        ...
        <table width="100%" border="1">    
            ...
            <tr>
                <td align="left" width="80%"><?php echo get_phrase('prise_en_charge'); ?> </td>
                <td align="right"><?php echo $row['pourcentage_prise']; ?>% </td>
            </tr>
            <tr>
        ...
        <table class="table table-bordered" width="100%" border="1" style="border-collapse:collapse;">
            ...
            <tbody>
                <?php
                $invoice_info = $this->db->get_where('invoice', array('invoice_number' => $row['invoice_number']))->result_array();
                foreach ($invoice_info as $row):
                    ?>
                    <tr>
                        <td><?php echo $row['creation_datetime']; ?></td>
                        <td><?php echo $grand_total . '&nbsp'. 'FCFA'; ?> </td>
