...
<div class="row">
    <div class="col-md-8" style="left: 180px;">
        <div class="panel panel-primary">
            ...
            <form method="post" action="<?php echo base_url(); ?>pharmacist/vente/update/<?php echo $row['vente_id']; ?>" class="p-70" id="form-validate" enctype="multipart/form-data">                
                <div class="row">       
                    ...
                    <div id="vente_entry_temp" style="display:none;">
                        <div class="form-group vente_entry">
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="js-states form-control amount pu" name="amount[]" value="" placeholder="<?php echo get_phrase('pu'); ?>" id="prix" readonly>
                            </div>
                            <div class="col-sm-2">
                            <input type="text" class="js-states form-control qte_vente quantite" id="qte" name="quantite[]" placeholder="<?php echo get_phrase('quantité'); ?>">
                            </div>
                            <div class="col-sm-2">
                                <input type="text" class="js-states form-control Ptotal prixT" id="pT" name="Ptotal[]" value="0" placeholder="<?php echo get_phrase('montant_total'); ?>" readonly>
                            </div>
                            <div class="col-sm-1">
                        ...
                        $invoice_ventes = json_decode($row['invoice_ventes']);
                            ...
                            <div class="form-group">
                               ...
                               <?php echo get_phrase('vente'); ?></label>
                                ...
                                <div class="col-sm-2">
                                <input type="text" class="js-states form-control qte_vente" name="qte_vente[]" value="<?php echo $vente_entry->qte_vente; ?>" >
                                </div>
                                <div class="col-sm-2">
