		...
		<div class="sidebar-nav">		
			<ul class="side-nav color-gray">
				...
				<li class="<?php if ($page_name == 'manage_fournisseur') echo 'active'; ?> ">
				    <a href="<?php echo base_url(); ?>pharmacist/fournisseur">
		        ...
		        <li class="<?php if ($page_name == 'manage_stock') echo 'active'; ?> ">
					<a href="<?php echo base_url(); ?>pharmacist/stock">
				...
				<li class="<?php if ($page_name == 'manage_vente') echo 'active'; ?> ">
					<a href="<?php echo base_url(); ?>pharmacist/vente">
					<i class="fa fa-shopping-cart" aria-hidden="true"></i>
					<span><?php echo get_phrase('vente-pharmacie'); ?></span>
					</a>
				</li>
				<!--<li class="</?php if ($page_name == 'manage_client') echo 'active'; ?> ">
					<a href="</?php echo base_url(); ?>pharmacist/client">
						<i class="fa fa-user-plus" aria-hidden="true"></i>
						<span></?php echo get_phrase('clients_internes'); ?></span>
					</a>
				</li>-->
