    ...
    <div class="col-md-12">
        <div class="panel-primary">
            ...
            <div class="panel-body">
                <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo base_url(); ?>pharmacist/stock/create" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-9">
                            <select name="medicine_id" class="form-control select2" id="medicine_id" data-validation="required">
                                <optgroup>
                                    ...
                                    $medicines = $medicines; // Inverser l'ordre des patients
                    ...
                    <div class="form-group">
                        <label for="qte_produit" class="col-sm-3 control-label">
                            <?php echo get_phrase('quantité-à-vendre'); ?><sup class="color-danger">*</sup>
                        </label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="date_liv" name="date_liv" value="<?php 
                        date_default_timezone_set('Africa/Niamey'); 
                        echo date("d-m-Y H:i:s"); ?>" required>
                        </div>
                    </div>
                    <div class="row">
                    <div class="col-md-12">
