...
<div class="row">
    <div class="col-md-8" style="left: 180px;">
		<div class="panel">
             <a href="<?php echo base_url(); ?>pharmacist/fournisseur" class="btn bg-black btn-wide pull-left"><i class="fa fa-arrow-left"></i> <?php echo get_phrase('retour'); ?></a>
			<div style="clear:both;"></div>						
			<div class="panel-body p-20">
			<form method="post" action="<?php echo base_url(); ?>pharmacist/fournisseur/update/<?php echo $row['fournisseur_id']; ?>" class="p-20" id="form-validate" enctype="multipart/form-data">				
