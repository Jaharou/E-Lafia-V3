...
<?php ob_start(); ?>
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <a class="dashboard-stat bg-primary" href="<?php echo base_url(); ?>magasin/stock">
            ...
            <div class="panel">
                <br>
                <a href="<?php echo base_url(); ?>pharmacist/vente_crud/add"
            ...
            foreach ($vente_info as $row): $i++; ?>
                <tr>
                   ...
                   <td><?php echo $row['date_vente'] ?></td>
                    <td>
                        <a 
                        href="<?php echo base_url(); ?>pharmacist/vente_crud/edit/<?php echo $row['vente_id']; ?>" 
                            class="btn btn-success btn-rounded icon-only" title="Modifier">
                            <i class="fa fa-pencil" aria-hidden="true"></i>
                        </a>
                        <a class="btn btn-warning btn-rounded icon-only" href="<?php echo base_url(); ?>InvoiceVentePharmacist/vente_print/<?php echo $row['vente_id']; ?>" title="Impression">
