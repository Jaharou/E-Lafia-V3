    ...
    <div class="col-md-12">
		<div class="panel">
			...
			<form method="post" action="<?php echo base_url(); ?>doctor/appointment/create" class="p-20" id="form-validate" enctype="multipart/form-data">				
                    <h5 class="mt-n"><?php echo get_phrase('nouveau-rendez-vous'); ?></h5>
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                            <label for="name13"><?php echo get_phrase("date-de-rendez-vous"); ?><sup class="color-danger">*</sup></label>
                            <input type="text" class="form-control" id="date_timestamp" name="date_timestamp"  data-validation="required"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="time" class="form-control" id="name13" name="time_timestamp"  data-validation="">
                            </div>
                        </div>
                        <div class="col-md-12">
