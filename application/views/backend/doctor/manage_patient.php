									...
									<tr>
										...
										<td>
											<a  onclick="showAjaxModal('<?php echo base_url();?>modal/popup/edit_patient/<?php echo $row['patient_id']?>');" 
												...
												<a class="btn btn-danger btn-sm btn-icon icon-left" href="#" onclick="confirm_modal('<?php echo base_url(); ?>doctor/patient/delete/<?php echo $row['patient_id']; ?>');" title="Supprimer">
													<i class="fa fa-user-md"></i>
													Supprimer
												</a> 
										</td>
