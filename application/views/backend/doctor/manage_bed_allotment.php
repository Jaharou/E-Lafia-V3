								...
								<?php foreach ($bed_allotment_info as $row): ?>   
									<tr>
										...
										<td>
											...
											<a class="btn btn-danger btn-sm btn-icon icon-left" href="#" onclick="confirm_modal('<?php echo base_url(); ?>doctor/bed_allotment/delete/<?php echo $row['bed_allotment_id']; ?>');" title="Supprimer">
													<i class="fa fa-user-md"></i>
													Supprimer
											</a> 
										</td>
