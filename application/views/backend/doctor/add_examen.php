...
<div class="row">
    <div class="col-md-9" style="left:180px;">
        <div class="panel panel-primary">
            ...
            <form method="post" action="<?php echo base_url(); ?>doctor/examen/create" class="p-20" id="form-validate" enctype="multipart/form-data">             
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="doctor_id"><?php echo get_phrase('utilisteur'); ?></label>
                        <select name="doctor_id" class="form-control select2" id="js-states" data-validation="">
                            <optgroup>
                            <option>Sélectionner votre nom</option>
                            <?php
                            $doctors = $this->db->get('doctor')->result_array();
                            $doctors = ($doctors); // Inverser l'ordre des doctors
