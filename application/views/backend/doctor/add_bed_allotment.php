                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select name="bed_id" class="js-states form-control" id="js-states"  data-validation="">
                ...
                <?php endforeach; ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
        					...
        					<input type="date" class="form-control" id="name13" name="allotment_timestamp" data-validation="">
                            </div>
                        </div>    
                    </div>
                    <div class="row">
                        <div class="col-md-12">
							...
							<input type="date" class="form-control" id="name12" name="discharge_timestamp" data-validation="">
                            </div>
                        </div>                                               
                   </div>
                   <div class="row">
