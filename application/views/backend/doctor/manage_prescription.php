...
<div class="row">
    <div class="col-md-12"><h5>Liste des ordonnances</h5>
		...
		<a href="<?php echo base_url(); ?>doctor/prescription_crud/add" class="btn bg-black btn-wide pull-right"> <i class="fa fa-plus"></i>
				 ...
				 <td><?php
				    ...
				    ?></td>
                      ...
                      <td><?php echo $row['note'];?></td>
						...
						<a class="btn btn-warning btn-rounded icon-only btn-animated" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/manage_diagnosis_report/<?php echo $row['prescription_id']?>/<?php echo $row['doctor_id']; ?>');" title="Comptes-rendus"><i class="fa fa-bars"></i></a> 
								<?php if($menu_check == 'from_prescription'): ?>
