							...
							<tr>
								...
								<td>
									<a onclick="showAjaxModal('<?php echo base_url();?>modal/popup/approve_appointment/<?php echo $row['appointment_id']; ?>');"
										class="btn btn-default btn-sm btn-icon icon-left" title="Approuver">
											<i class="fa fa-user-md"></i>
											Approuver
									</a>									
									<a class="btn btn-danger btn-sm btn-icon icon-left" href="#" onclick="confirm_modal('<?php echo base_url(); ?>doctor/appointment_requested/delete/<?php echo $row['appointment_id']; ?>');" title="Supprimer">
										<i class="fa fa-user-md"></i>
										Supprimer
									</a> 
								</td>
