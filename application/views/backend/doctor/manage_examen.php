...
<div class="col-md-12">
    <div class="panel">
        <a href="<?php echo base_url(); ?>doctor/examen_crud/add"
        ...
        <div class="panel-body p-20">
            <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    if ($now->format('H') >= 8) {
                        $start_of_day->setTime(8, 0);
                        $end_of_day->setTime(18, 0)->modify('+1 day');
                    } else {
                        $start_of_day->setTime(8, 0)->modify('-1 day');
                        $end_of_day->setTime(18, 0);
                    }
                    ...
                    foreach ($exams as $examen) {
                        ...
                        echo "  </td>
                                <td>" . $examen['status'] . "</td>
                                <td>
                                    <a href=\"" . base_url() . "doctor/examen_crud/edit/" . $examen['id_examen'] . "\" class=\"btn btn-success btn-rounded icon-only\" title=\"Modifier\">
                                        <i class=\"fa fa-pencil\" aria-hidden=\"true\"></i>
                                    </a>
                                    <a class=\"btn btn-warning btn-rounded icon-only\" href=\"" . base_url() . "InvoiceExamenMedecin/examenMedecin_print/" . $examen['id_examen'] . "\" title=\"Impression\">
                                        <i class=\"fa fa-print\"></i>
                                    </a>
                                    <a class=\"btn btn-danger btn-rounded icon-only\" href=\"#\" onclick=\"confirm_modal('" . base_url() . "doctor/examen/delete/" . $examen['id_examen'] . "');\" title=\"Supprimer\">
