    ...
    <tbody>
        <?php foreach ($diagnosis_report_info as $row) { ?>   
            <tr>
                ...
                <td>
                    <a href="<?php echo base_url().'uploads/diagnosis_report/'.$row['file_name']; ?>" class="btn btn-primary btn-rounded icon-only btn-animated" title="voir">
                        <i class="fa fa-eye"></i>          
                    </a>
                      <?php if($doctor_id == $this->session->userdata('login_user_id')): ?>	
                    <a class="btn btn-danger btn-rounded icon-only" href="#" onclick="confirm_modal('<?php echo base_url(); ?>doctor/diagnosis_report/delete/<?php echo $row['diagnosis_report_id']; ?>');" title="Supprimer">
...
<?php } else { ?>
    <p style="font-size: 15px;">Aucun compte rendu n'a encore été créé pour cette ordonnance.</p>
<?php } if($doctor_id == $this->session->userdata('login_user_id')) { ?>
<hr>
<div class="row">
    <div class="col-md-12">
        <div class="panel">
            ...
            <form method="post" action="<?php echo base_url(); ?>doctor/diagnosis_report/create" class="p-20" id="form-validate" enctype="multipart/form-data">             
                    <h5 class="mt-n"><?php echo get_phrase('nouveau-compte-rendu'); ?></h5>
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                            <div class="form-group">
                                <label for="report_type"><?php echo get_phrase('type-de-compte-rendu'); ?><sup class="color-danger">*</sup></label>
                                <select name="report_type" class="js-states form-control" id="js-states"  data-validation="required">
                                    <optgroup>
                                        <option value="xray"><?php echo get_phrase('radiographies'); ?></option>
                                        <option value="xray"><?php echo get_phrase('Echographies'); ?></option>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="name13"><?php echo get_phrase('document'); ?></label>
                                <input type="file" class="form-control" id="name13" name="file_name" data-validation="">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="name13"><?php echo get_phrase('description'); ?></label>
                                <textarea type="text" class="form-control" id="name13" name="description"  data-validation="">
                            </textarea>
                            </div>
                        </div>
                    </div>
