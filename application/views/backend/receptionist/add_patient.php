...
<div class="row">
    <div class="col-md-8" style="left: 180px;">
        <div class="panel">
            ...
            <form method="post" action="<?php echo base_url(); ?>receptionist/patient/create" class="p-5" id="form-validate" enctype="multipart/form-data" data-ajax-target="patient" data-task="create">
                <div class="row panel panel-primary">       
                  <div class="panel-heading">
                    <div class="panel-title" >
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="birth_date"><?php echo get_phrase('date-naissance'); ?></label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="sex" class="js-states form-control" id="js-states"  data-validation="">
                                    <optgroup>
                                    <option>-</option>  
                                <option value="masculin"><?php echo get_phrase('masculin'); ?></option>
                                <option value="feminin"><?php echo get_phrase('feminin'); ?></option>
                                    </optgroup>
                                </select>  
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="name13"><?php echo get_phrase('situation-famil'); ?></label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="name13"></?php echo get_phrase('personne-contacter'); ?><sup class="color-danger"></sup></label>
                       ...
                       <div class="row panel panel-primary" data-collapsed="0">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="name13"><?php echo get_phrase("Tél-d'urgence"); ?><sup class="color-danger"></sup></label>
                                <input type="text" class="form-control" id="name13" name="phone"  data-validation="">
                            </div>
                        </div>
                    </div>
                    <div class="row panel panel-primary" data-collapsed="0">
                      <div class="panel-heading">
                       <div class="panel-title" >
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="name13"><?php echo get_phrase('Médecin-traitant'); ?><sup class="color-danger"></sup></label>
