        ...
        <div class="col-md-12">
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo base_url(); ?>receptionist/stock/update/<?php echo $row['stock_id']; ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="movement_type" class="js-states form-control selectboxit" id="movement_type">
                                <option value="Entrée" <?php if ($row['movement_type'] == 'Entrée') echo 'selected'; ?> >
                                    <?php echo get_phrase('Entrée'); ?>
                                </option>
                        ...
                        <div class="form-group">
                            <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('date_livraison'); ?></label>
                            <div class="col-sm-9">
                            <input type="date" name="date_liv" class="form-control" id="field-1" value="<?php echo $row['date_liv']; ?>">
                            </div>
                        </div>
