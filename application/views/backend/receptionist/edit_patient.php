    ...
    <div class="col-md-8" style="left: 180px;">
		<div class="panel">
			...
			<form method="post" action="<?php echo base_url(); ?>receptionist/patient/update/<?php echo $row['patient_id']; ?>" class="p-20" id="form-validate" enctype="multipart/form-data"
				  data-ajax-target="patient" data-task="update" data-patient-id="<?php echo $row['patient_id']; ?>">				
                  ...
                  <div class="panel-heading">
                    <div class="panel-title" >
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="civilite" id="js-states" class=" js-states form-control">
                                    <optgroup >
                                    <option>-</option>
                                    <option value="M" <?php if ($row['civilite'] == 'M') echo 'selected'; ?> >
                                    <?php echo get_phrase('M'); ?>
                                    </option>
                                    <option value="Mme" <?php if ($row['civilite'] == 'Mme') echo 'selected'; ?> >
                                    <?php echo get_phrase('Mme'); ?>
                                    </option> 
                                    <option value="Mlle" <?php if ($row['civilite'] == 'Mlle') echo 'selected'; ?> >
                                    <?php echo get_phrase('Mlle'); ?>
                                    </option>
                                    </optgroup>
                                </select>  
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" name="name"  data-validation="required" value="<?php echo $row['name']; ?>">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="name13"><?php echo get_phrase('prénom'); ?><sup class="color-danger"></sup></label>
                                <input type="text" class="form-control" id="prenom" name="prenom"  data-validation="" value="<?php echo $row['prenom']; ?>">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="name13"><?php echo get_phrase('date_de_naissance'); ?></label>
                                <input type="date" class="form-control" id="birth_date" name="birth_date"  data-validation="" value="<?php echo $row['birth_date']; ?>" >
                            </div>
                        </div>
                         <div class="col-md-3">
                            <div class="form-group">
                                <label for="name13"><?php echo get_phrase('age'); ?></label>
                                <input type="text" class="form-control" id="name13" name="age"  data-validation="" value="<?php echo $row['age']; ?>">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="situation_famil" class="js-states form-control" id="js-states"  data-validation="">
                                    ...
                                    <option>-</option>
                                    <option value="celiba" <?php if ($row['situation_famil'] == 'celiba') echo 'selected'; ?> >
                                    <?php echo get_phrase('celibataire'); ?>
                                    </option>
                                    <option value="Marié(e)" <?php if ($row['situation_famil'] == 'Marié(e)') echo 'selected'; ?> >
                                    <?php echo get_phrase('Marié(e)'); ?>
                                    </option>
                                    <option value="divorce" <?php if ($row['situation_famil'] == 'divorce') echo 'selected'; ?> >
                                    <?php echo get_phrase('divorcé'); ?>
                                    </option>
                                    <option value="Veuf(ve)" <?php if ($row['situation_famil'] == 'Veuf(ve)') echo 'selected'; ?> >
                                    <?php echo get_phrase('Veuf(ve)'); ?>
                                    </option>
                                    </optgroup>
                                </select>  
                            </div>
                    ...
                    <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name13" name="phone"  data-validation="" value="<?php echo $row['phone']; ?>">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="name13"><?php echo get_phrase('adresse'); ?><sup class="color-danger"></sup></label>
                                <input type="text" class="form-control" id="name13" name="address_patient"  data-validation="" value="<?php echo $row['address_patient']; ?>">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name13" name="password"  data-validation="" value="<?php echo $row['password']; ?>">
                            </div>
                        </div>
                     </div>
                     <div class="row panel panel-primary" data-collapsed="0">
                    ...
                    <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="personne_contacter" name="personne_contacter"  data-validation="" value="<?php echo $row['personne_contacter']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="tel_contacter" name="tel_contacter"  data-validation="" value="<?php echo $row['tel_contacter']; ?>">
                            </div>
                         </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="profession" name="profession"  data-validation="" value="<?php echo $row['profession']; ?>">
                            </div>
                        </div>   
                        ...
                        <div class="col-md-3">
                            ...
                            foreach ($services as $row2):
                                ?>
                                <option value="<?php echo $row2['service_title']; ?>" <?php if ($row['service_id'] == $row2['service_id']) echo 'selected'; ?> >
