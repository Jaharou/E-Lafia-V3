				    ...
				    <tbody>								
						...
						<tr>
							...
							<td>
								...
								<a class="btn btn-danger btn-sm btn-icon icon-left" href="#" onclick="confirm_modal('<?php echo base_url(); ?>receptionist/medicine/delete/<?php echo $row['medicine_id']; ?>');" title="Supprimer"><i class="fa fa-user-md">Supprimer</i>
								</a>
							</td>
						</tr>
						<?php endforeach; ?>
