    ...
    <div class="col-md-8" style="left: 240px;">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body p-20">
                <form method="post" action="<?php echo base_url(); ?>receptionist/traitement/create" class="p-10" id="form-validate" enctype="multipart/form-data">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="amount_prod" name="amount_prod[]" readonly>
                </div>
            </div>
            <script>
