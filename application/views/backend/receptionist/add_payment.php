...
<?php $output = ''; ?>
<?php ob_start(); ?>
<?php $paymentNumber = $this->db->count_all('payment')+1; ?>
<div class="row">
    <div class="col-md-9" style="left:180px;">
		<div class="panel panel-primary">
             <a href="<?php echo base_url(); ?>payment/insert_payments" class="btn bg-black btn-wide pull-left"><i class="fa fa-arrow-left"></i> <?php echo get_phrase('retour'); ?></a>
			<div style="clear:both;"></div>
            <h5 class="panel mt-n" style="text-align: center; color: black;"><?php echo get_phrase('nouvelle-analyse'); ?></h5>
			<div class="panel-body p-20">
			<form method="post" action="<?php echo base_url(); ?>payment/insert_payments/add" class="p-20" id="form-validate" enctype="multipart/form-data">				
                    
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="name13"><?php echo get_phrase("numéro"); ?><sup class="color-danger"></sup></label>
                                <input type="text" class="form-control" id="examen_number" name="payment_number"  data-validation="" value="<?php echo "0".$paymentNumber; ?>" readonly >
                            </div>
                        </div> 
                        <div class="col-md-3">
                        <div class="form-group">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="amount_examen" name="amount_examen[]" data-validation="" readonly>
                    </div>
                </div>
                <script>
