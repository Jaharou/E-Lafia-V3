			...
			<ul class="side-nav color-gray">
				...
				<li class="<?php if ($page_name == 'manage_invoice') echo 'active'; ?> ">
					<a href="<?php echo base_url(); ?>accountant/invoice_manage">
						...
						<span><?php echo get_phrase('reçu-consultation'); ?></span>
						
					</a>	
				</li>
				<li class="<?php if ($page_name == 'manage_vente') echo 'active'; ?> ">
					<a href="<?php echo base_url(); ?>accountant/vente">
						<i class="fa fa-shopping-cart" aria-hidden="true"></i>
						<span><?php echo get_phrase('reçu-vente'); ?></span>
					</a>
				</li>
				<li class="<?php if ($page_name == 'manage_examen') echo 'active'; ?> ">
					<a href="<?php echo base_url(); ?>accountant/examen">
						<i class="fa fa-shopping-cart" aria-hidden="true"></i>
						<span><?php echo get_phrase('reçu-examen'); ?></span>
					</a>
				</li>
