...
<div class="row">
    <div class="col-md-8" style="left: 180px;">
        <div class="panel panel-primary">
             <a href="<?php echo base_url(); ?>admin/vente" class="btn bg-black btn-wide pull-left"><i class="fa fa-arrow-left"></i> <?php echo get_phrase('retour'); ?></a>
            <div style="clear:both;"></div>                     
            <div class="panel-body p-70">
            <form method="post" action="<?php echo base_url(); ?>admin/vente/update/<?php echo $row['vente_id']; ?>" class="p-70" id="form-validate" enctype="multipart/form-data">                
                <div class="row">       
                    ...
                    <div id="vente_entry_temp" style="display:none;">
                        <div class="form-group vente_entry">
                            ...
                            <div class="col-sm-2">
                            <input type="text" class="js-states form-control qte quantite" id="qte" name="quantite[]" placeholder="<?php echo get_phrase('quantité'); ?>">
                            </div>
                            <div class="col-sm-2">
                        ...
                        $invoice_ventes = json_decode($row['invoice_ventes']);
                            ...
                            <div class="form-group">
                               ...
                               <?php echo get_phrase('vente'); ?></label>
                                ...
                                <div class="col-sm-2">
                                <input type="text" class="js-states form-control qte quantite" name="quantite[]" value="<?php echo $vente_entry->qte; ?>" >
                                </div>
                                <div class="col-sm-2">
