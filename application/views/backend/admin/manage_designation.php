...
<div class="row">
    <div class="col-md-12">
		...
		<table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
			<thead>
			<tr>
				<th><?php echo get_phrase('libellé'); ?></th>
				...
				<tr>
					...
					<td>
					<a 
                        href="<?php echo base_url(); ?>admin/designation_crud/edit/<?php echo $row['entry_description_id']; ?>"
                        class="btn btn-success btn-rounded icon-only" title="Modifier">
                        <i class="fa fa-pencil" aria-hidden="true"></i>
                    </a>
					<a class="btn btn-danger btn-rounded icon-only" href="#"onclick="confirm_modal('<?php echo base_url(); ?>admin/designation/delete/<?php echo $row['entry_description_id']; ?>');" title="Supprimer">
