                ...
                <tbody>
                                ...
                                foreach ($invoice_entries_data as $invoice_entry_json) {
                                    ...
                                    if (is_array($invoice_entries)) {
                                        foreach ($invoice_entries as $entry) {
                                            if (isset($entry['description']) && isset($entry['amount'])) {
                                                echo $entry['description'] . " - " . $entry['amount'] . " FCFA<br>";
                                            } else {
                                ...
                                foreach ($examen_entries_data as $examen_entry_json) {
                                    ...
                                    if (is_array($examen_entries)) {
                                        foreach ($examen_entries as $entry) {
                                            if (isset($entry['description']) && isset($entry['montant'])) {
                                                echo $entry['description'] . " - " . $entry['montant'] . " FCFA<br>";
                                            } else {
                                                echo "Données incorrectes";
                                            }
                                        }
                    ...
                    <!--Affichage des descriptions dans traitement_entries-->
                        ...
                        <td>
                            ...
                            <br><br>
                            <a class="btn btn-danger btn-rounded icon-only" href="#" onclick="confirm_modal('<?php echo base_url(); ?>receptionist/facture/delete/<?php echo $row['facture_id']; ?>');">
