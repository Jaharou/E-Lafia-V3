    ...
    <div class="col-md-8" style="left: 240px;">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body p-20">
                <form method="post" action="<?php echo base_url(); ?>admin/vente/create" class="p-10" id="form-validate" enctype="multipart/form-data">

            <div class="col-md-3">
                <div class="form-group">
                    <label for="name13"><?php echo get_phrase('numéro_de_vente'); ?><sup class="color-danger"></sup></label>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select name="medicine_id[]" class="form-control select2" id="stock_id">
                        <optgroup>
