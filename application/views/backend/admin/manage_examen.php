<?php
/*
 *  Liste : Examens (administration)
 *
 *  Recherche, tri et pagination sont effectués côté serveur
 *  (admin/list_datatable/examen). La table est volontairement vide au
...
<div class="row">
    <div class="col-md-12">
        <div class="panel">
            <a href="<?php echo base_url(); ?>admin/examen_crud/add" class="btn btn-info btn-wide pull-right">
                <i class="fa fa-plus"></i> <?php echo get_phrase('ajouter'); ?>
            </a>
            <header style="color: dark; font-size: 23px;">Examens</header>
            <div style="clear:both;"></div>
            <div class="panel-body p-20">
                <table data-admin-list="examen" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                    <thead>
                        <tr>
