			...
			<form method="post" action="<?php echo base_url(); ?>admin/doctor/create" class="p-20" id="form-validate" enctype="multipart/form-data">				
                    ...
                    <div class="row">
                     ...
                     <div class="row">
                      ...
                      <div class="col-md-3">
                            <div class="form-group">
                                <label for="department_id"><?php echo get_phrase('département'); ?></label>
                                <select name="department_id" class="js-states form-control" id="js-states"  data-validation="">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="name13"><?php echo get_phrase('profil'); ?></label>
                                <input type="text" class="form-control" id="name13" name="profile"  data-validation="">
                            </div>
                        </div>
