						    ...
						    <tbody>
								 <?php foreach ($services_info as $row): ?>   
										<tr>
											...
											<td>
												<a class="btn btn-danger btn-rounded icon-only" href="#" onclick="confirm_modal('<?php echo base_url(); ?>admin/services/delete/<?php echo $row['service_id']; ?>');" title="Supprimer">
