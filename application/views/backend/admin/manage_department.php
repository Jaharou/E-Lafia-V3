								 ...
								 <?php foreach ($department_info as $row): ?>   
										<tr>
											...
											<td>
												...
												<a class="btn btn-danger btn-sm btn-icon icon-left" href="#" onclick="confirm_modal('<?php echo base_url(); ?>admin/department/delete/<?php echo $row['department_id']; ?>');" title="Supprimer">
													<i class="fa fa-user-md"></i>
													supprimer
												</a>  
											</td>
