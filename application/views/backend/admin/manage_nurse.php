						    ...
						    <tbody>							
								<?php foreach ($nurse_info as $row): ?>   
									<tr>
										...
										<a href="<?php echo base_url(); ?>admin/nurse_crud/edit/<?php echo $row['nurse_id']; ?>" class="btn btn-success btn-rounded icon-only" title="Modifier">
														<i class="fa fa-pencil"></i>
												</a> 
												
												<a class="btn btn-warning btn-rounded icon-only" href="<?php echo base_url(); ?>NursePrint/nurse_fpdf/<?php echo $row['nurse_id']; ?>" title="Impression">
													<i class="fa fa-print"></i>			
												</a>                          
												<a class="btn btn-danger btn-rounded icon-only" href="#" onclick="confirm_modal('<?php echo base_url(); ?>admin/nurse/delete/<?php echo $row['nurse_id']; ?>');" title="Supprimer">
