        ...
        <div class="panel">
            ...
            <form method="post" action="<?php echo base_url(); ?>admin/system_settings/do_update" class="p-20" id="form-validate" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="name13"><?php echo get_phrase('NIF'); ?><sup class="color-danger">*</sup></label>
                                <input type="text" class="form-control" id="name13" name="system_nif" data-validation="required" value="<?php echo $this->db->get_where('settings', array('type' => 'system_nif'))->row()->description; ?>">
                            </div>
                        </div>
