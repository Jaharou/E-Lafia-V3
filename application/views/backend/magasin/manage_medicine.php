				    ...
				    <tbody>								
						...
						<tr>
							...
							<td>
								...
								<a class="btn btn-danger btn-sm btn-icon" href="#" onclick="confirm_modal('<?php echo base_url(); ?>magasin/medicine/delete/<?php echo $row['medicine_id']; ?>');" title="Supprimer"><i class="fa fa-trash-o"></i>
								</a>
							</td>
						</tr>
						<?php endforeach; ?>
