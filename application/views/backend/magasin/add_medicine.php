    ...
    <div class="col-sm-12">
        ...
        <div class="panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo base_url(); ?>magasin/medicine/create" method="post" enctype="multipart/form-data">
                <div class="col-sm-3">
                    <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('fournisseur'); ?></label>
