...
<div class="row">
    <div class="col-md-8" style="left: 180px;">
		<div class="panel">
            <header>Nouveau stock</header><br>
             <a href="<?php echo base_url(); ?>magasin/stock" class="btn bg-black btn-wide pull-left"><i class="fa fa-arrow-left"></i> <?php echo get_phrase('retour'); ?></a>
			<div style="clear:both;"></div>						
			<div class="panel-body p-5">
			<form method="post" action="<?php echo base_url(); ?>magasin/stock/create" class="p-5" id="form-validate" enctype="multipart/form-data">
                  ...
                  <div class="panel-heading">
                    <div class="panel-title" >
                       ...
                       <optgroup>
                        ...
                        <?php
                        $fournisseurs = $this->db->get('medicine')->result_array();
