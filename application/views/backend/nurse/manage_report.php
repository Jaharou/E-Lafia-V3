...
<button onclick="showAjaxModal('<?php echo base_url();?>modal/popup/add_report/');" 
    class="btn bg-black pull-right"><i class="fa fa-plus-square"></i>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="operation">
                ...
                <table class="table table-bordered table-striped datatable" id="example">
                    <thead>
                        <tr>
                            <th class="col-md-6"><?php echo get_phrase('description'); ?></th>
                            <th><?php echo get_phrase('date'); ?></th>
                            <th class="col-md-3"><?php echo get_phrase('patient'); ?></th>
                        ...
                        foreach ($report_info as $row) { ?>   
                            <tr>
                                ...
                                <td class="col-md-3">
                                    ...
                                    <a  onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/edit_report/<?php echo $row['report_id'] ?>');" 
                                        class="btn btn-warning btn-sm btn-icon icon-left" title="Imprimer">
                                        <i class="fa fa-print"></i>
                                         
                                    </a>
									<a class="btn btn-danger btn-sm btn-icon icon-left" href="#" onclick="confirm_modal('<?php echo base_url(); ?>nurse/report/delete/<?php echo $row['report_id']; ?>');" title="Supprimer">
