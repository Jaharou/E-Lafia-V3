        ...
        <div class="col-md-8" style="left:180px;">
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body p-20">
                    <form role="form" class="form-horizontal p-20 form-groups-bordered" action="<?php echo base_url(); ?>laboratorist/examen/update/<?php echo $row['id_examen']; ?>" method="post" enctype="multipart/form-data">
                        <div class="row">
                        <div class="form-group">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase("numéro-d'examen"); ?></label>
                        <div class="col-sm-9">
                            <input type="text" class="js-states form-control" name="examen_number"  value="<?php echo $row['examen_number']; ?>"  readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <?php
                                // Recherche AJAX (Select2) au lieu de charger tous les patients :
                                // seul le patient actuellement rattaché est pré-chargé ici, les
                                // autres sont récupérés à la volée pendant la frappe.
                                $current_patient = $this->db->get_where('patient', array('patient_id' => $row['patient_id']))->row_array();
                                ?>
                                <select name="patient_id" class="form-control" id="patient_id"
                                        data-validation="required"
                                        data-patient-autocomplete="1"
                                        data-placeholder="Rechercher un patient (nom, prénom, téléphone)">
                                    <?php if ($current_patient): ?>
                                    <option value="<?php echo $current_patient['patient_id']; ?>" selected>
                                        <?php echo $current_patient['name'] . ' ' . $current_patient['prenom']; ?>
                                    </option>
                                    <?php endif; ?>
                            </select>
                        </div>
                    ...
                    <hr>
                    <span style="color: green; font-size: 25px;">Espace nouveau examen</span><hr>
                    <div class="form-group">
                    ...
                    <div id="examen_entry_temp" style="display:none;">
                        <div class="form-group examen_entry">
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="js-states form-control amount" name="unite_mesure[]" value="" placeholder="<?php echo get_phrase('unité-de-mesure'); ?>" id="unite_mesure">
                            </div>
                            <div class="col-sm-2">
                                <input type="text" class="js-states form-control amount" name="intervalle[]" value="" placeholder="<?php echo get_phrase('intervalle'); ?>" id="intervalle">
                            </div>
                            <div class="col-sm-1">
                    ...
                    <div class="form-group">
                       ...
                       <?php echo get_phrase('examen'); ?></label>
                        ...
                        <div class="col-sm-2">
                            ...
                            value="<?php echo $examen_entry->montant; ?>" readonly>
                        </div>
                        <div class="col-sm-2">
                            <input type="text" name="qte_examen[]" class="form-control" placeholder="<?php echo get_phrase('quantité'); ?>" id="qte_examen"
                            value="<?php echo $examen_entry->qte_examen; ?>" readonly>
                        </div>
                        <div class="col-sm-2">
                            <input type="text" name="amountT[]" class="form-control" placeholder="<?php echo get_phrase('montant-total'); ?>" id="amountT"
                            value="<?php echo $examen_entry->amountT; ?>" readonly>
                        </div>
                        <label for="field-1" class="col-sm-3 control-label">
                       </*?php echo get_phrase('examen'); ?*/></label>
                        <div class="col-sm-2">
                            <input type="text" name="resultat_examen[]" class="form-control" placeholder="<?php echo get_phrase('résultat'); ?>" id="resultat_examen"
                            value="<?php echo $examen_entry->resultat; ?>">
                        </div>
                        <div class="col-sm-2">
                            <input type="text" name="unite_mesure[]" class="form-control" placeholder="<?php echo get_phrase('unité-de-mesure'); ?>" id="unite_mesure"
                            value="<?php echo $examen_entry->unite; ?>">
                        </div>
                        <div class="col-sm-2">
                            <input type="text" name="intervalle[]" class="form-control" placeholder="<?php echo get_phrase('intervalle'); ?>" id="intervalle"
                            value="<?php echo $examen_entry->intervalle; ?>">
                        </div>
