...
<div class="row">
    <div class="col-md-8" style="left: 180px;">
		<div class="panel">
             <a href="<?php echo base_url(); ?>laboratorist/patient" class="btn bg-black btn-wide pull-left"><i class="fa fa-arrow-left"></i> <?php echo get_phrase('retour'); ?></a>
			<div style="clear:both;"></div>						
			<div class="panel-body p-20">
			<form method="post" action="<?php echo base_url(); ?>laboratorist/patient/update/<?php echo $row['patient_id']; ?>" class="p-20" id="form-validate" enctype="multipart/form-data"
                  ...
                  <div class="panel-heading">
                    <div class="panel-title" >
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="name13"><?php echo get_phrase('date_de_naissance'); ?><sup class="color-danger">*</sup></label>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="name13"><?php echo get_phrase('catégorie'); ?><sup class="color-danger"></sup></label>
                                <input type="text" class="form-control" id="categorie" name="categorie"  data-validation="" value="<?php echo $row['categorie']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="assurance" name="assurance"  data-validation="" value="<?php echo $row['assurance']; ?>">
                            </div>
                        </div>
