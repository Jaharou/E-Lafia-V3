...
<div class="row">
    ...
    <div class="col-md-8" style="left: 180px;">
		<div class="panel">
			...
			<form method="post" action="<?php echo base_url(); ?>laboratorist/patient/create" class="p-5" id="form-validate" enctype="multipart/form-data">
                <div class="panel panel-heading panel-info">
                    <div class="panel-title" style="text-align:center;">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="birth_date"><?php echo get_phrase('date_de_naissance'); ?></label>
